...
if(!class_exists('Ultimate_Icon_Timeline'))
{
	class Ultimate_Icon_Timeline
	{
		...
		function icon_timeline_sep($atts, $content=null){
			$time_sep_title = $time_sep_color = $time_sep_bg_color = $animation = $el_class = $line_style = $line_color =  $icon_style ='';
			extract(shortcode_atts(array(
				'time_sep_title' => '. . .',
				'time_sep_color' => '',
				'time_sep_bg_color' =>'',
			...
			$output ='</div>';
			$output .= '
				<div class="timeline-separator-text" data-sep-col="'.$time_sep_color.'" data-sep-bg-col="'.$time_sep_bg_color.'"><span class="sep-text">'.$time_sep_title.'</span></div><div class="timeline-wrapper ">';
			//$li_prefix = '<div class="timeline-block separator'.$el_class.'">';
			//$li_suffix = '</div>';			
			$style ='';
		...
		function icon_timeline_feat($atts,$content = null){
			...
			$header .= '<h3 class="ult-timeline-title">'.$time_title.'</h3>';
			...
			$header .= '<p>'.do_shortcode($content).'</p>';						
			...
			$html =  $icon . $header ;
			$feat_spl ='</div>';
			$feat_spl .= '<div class="timeline-feature-item feat-item ">';

			$contt.='<div class="feat-dot"><div class="timeline-dot"></div></div><div class="ult-timeline-arrow"><s></s><l></l></div>'.$html;
