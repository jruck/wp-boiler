					...
					array(
					   ...
					   "params" => array(
						  ...
						  array(
							 ...
							 "value" => "1250",
							 "description" => __("Enter number for counter without any special characters. e.g 125000 or 12.75", "smile")
						  ),
						  array(
							 "type" => "textfield",
							 "class" => "",
							 "heading" => __("Digit Separator", "smile"),
							 "param_name" => "counter_sep",
							 "value" => ",",
							 "description" => __("Enter character for decimal digit separator. e.g. ',' will separate 125000 into 1,25,00", "smile")
						  ),
						  array(
							 "type" => "textfield",
							 "class" => "",
							 "heading" => __("Decimal Character", "smile"),
							 "param_name" => "counter_decimal",
							 "value" => ".",
							 "description" => __("Enter custom charater for decimal. e.g '.' or '/' ", "smile"),
						  ),
						  array(
							 "type" => "textfield",
							 "class" => "",
						  ...
						  array(
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Couter Text Color", "smile"),
